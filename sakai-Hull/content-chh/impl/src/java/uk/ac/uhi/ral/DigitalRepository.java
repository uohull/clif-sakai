...
public interface DigitalRepository {
  ...
  public static final String CONFIG_KEY_CLIF_FEDORA_WRITEABLE_COLLECTION_PID = "clif.fedora-writeable-collection-pid";  
  ...
  public static final String CONFIG_KEY_CLIF_PUBLISHER = "clif.publisher";
  public static final String CONFIG_KEY_CLIF_COPYRIGHT = "clif.copyright";
