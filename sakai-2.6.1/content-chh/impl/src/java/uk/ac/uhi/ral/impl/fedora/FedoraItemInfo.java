...
public class FedoraItemInfo implements DigitalItemInfo {
  ...
  private FedoraDigitalRepositoryImpl cHH;   // CLIF
  ...
  public String getMimeType() {
	if(((mimeType == null) || (mimeType == "")) && cHH != null)  
		cHH.gatherMoreResourceData(this);
  ...
  public void setCHH(FedoraDigitalRepositoryImpl chh) {
	  cHH = chh;	  
  }
